...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton paintNodeButton;
    private JButton addAdgeButton;
    private JButton buttonIsEuler;
    private JLabel labelIfEuler;
    ...
    public GraphDemoFrame() {
        ...
        paintNodeButton.addActionListener(e -> {
            try {
                AdjMatrixDigraph graph = new AdjMatrixDigraph();
                String graphInDot = textAreaDotFile.getText();
//                graph.dotToDigraph(graphInDot);
                int nStart = Integer.parseInt(startTextField.getText());
                int nFinish = Integer.parseInt(finishTextField.getText());
//                graph.searchCountGraphPaths(nStart, nFinish);
                textAreaDotFile.setText(graph.toDot());
                panelGraphvizPainter.paint(textAreaDotFile.getText());

            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
        addAdgeButton.addActionListener(e -> {
            try {
                int nStart = Integer.parseInt(startTextField.getText());
                int nFinish = Integer.parseInt(finishTextField.getText());
                graph.addAdge(nStart, nFinish);
                panelGraphvizPainter.paint(graph.toDot());
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
        });
        buttonIsEuler.addActionListener(e -> {
            boolean isEuler = graph.isEuler();
            if (isEuler) {
                labelIfEuler.setText("Эйлеров");
            } else {
                labelIfEuler.setText("Не Эйлеров");
            }
        });
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel7.setBackground(new Color(-6226016));
        ...
        buttonIsEuler = new JButton();
        buttonIsEuler.setBackground(new Color(-10158236));
        buttonIsEuler.setText("Проверка на Эйлеровость");
        panel7.add(buttonIsEuler, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JPanel panel8 = new JPanel();
        panel8.setLayout(new GridLayoutManager(1, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel8.setBackground(new Color(-6226016));
        ...
        labelIfEuler = new JLabel();
        labelIfEuler.setBackground(new Color(-6226016));
        labelIfEuler.setText("");
        panel8.add(labelIfEuler, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel11.add(panel14, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        panel16.add(startTextField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel17.add(finishTextField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final Spacer spacer13 = new Spacer();
        panel17.add(spacer13, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final JPanel panel18 = new JPanel();
        panel18.setLayout(new GridLayoutManager(1, 2, new Insets(0, 0, 0, 0), -1, -1));
        panel15.add(panel18, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        paintNodeButton = new JButton();
        paintNodeButton.setText("Подсветить вершины");
        panel18.add(paintNodeButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel15.add(panel19, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        addAdgeButton = new JButton();
        addAdgeButton.setText("Добавить ребро");
        panel19.add(addAdgeButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer15 = new Spacer();
        panel19.add(spacer15, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
    }
